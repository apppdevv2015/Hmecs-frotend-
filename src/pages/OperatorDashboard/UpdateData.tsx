...
// import { fleetService, type FleetMachine as ServiceFleetMachine } from "../../services/Fleet/fleetService";
...
// swap alongside MOCK_COMPONENT_LIFE once the real API is wired.
const MOCK_SUB_METRICS: Record<ComponentKey, Record<string, number>> = {
  tyre: { airPressure: 34, temperature: 48 },
  engine: { temperature: 108, engineOil: 62, coolant: 58 },
  hydraulic: { oilLevel: 88, pressure: 205, temperature: 57 },
  transmission: { oilLevel: 22, temperature: 82 },
};

const MOCK_AVG_HEALTH = Math.round(
  (MOCK_COMPONENT_LIFE.tyre +
    MOCK_COMPONENT_LIFE.engine +
    MOCK_COMPONENT_LIFE.hydraulic +
    MOCK_COMPONENT_LIFE.transmission) /
    4,
);

const MOCK_ASSIGNED_MACHINE: FleetMachine = {
  id: "MCH-1042",
  machine: "Excavator EX-220",
  company: "HME Mining Pvt. Ltd.",
  fleet: "Fleet-A",
  operator: "Rohit Sharma",
  location: "Zone 3 — Open Pit",
  type: "Excavator",
  healthPercent: MOCK_AVG_HEALTH,
  status: deriveFleetStatus(MOCK_AVG_HEALTH),
  lastSeen: "2 mins ago",
  hoursRun: 4820,
  fuelLevel: 64,
  tyre: buildComponent(
    ...
    "TYRE",
    MOCK_COMPONENT_LIFE.tyre,
    MOCK_SUB_METRICS.tyre,
  ),
  engine: buildComponent(
    "engine",
    "ENGINE",
    MOCK_COMPONENT_LIFE.engine,
    MOCK_SUB_METRICS.engine,
  ),
  hydraulic: buildComponent(
    "hydraulic",
    "HYDRAULIC",
    MOCK_COMPONENT_LIFE.hydraulic,
    MOCK_SUB_METRICS.hydraulic,
  ),
  transmission: buildComponent(
    "transmission",
    "SUSPENSION",
    MOCK_COMPONENT_LIFE.transmission,
    MOCK_SUB_METRICS.transmission,
  ),
  maintenanceHistory: [
    {
      date: "07 Jul 2026",
      ...
      technician: "A. Verma",
      notes: "Life dropped below 20% — flagged for replacement this week.",
    },
    {
      date: "02 Jul 2026",
      type: "Health Check Update",
      technician: "R. Sharma",
      notes: "Engine showing early wear, life reduced to 35%.",
    },
    {
      date: "24 Jun 2026",
      type: "Tyre Rotation",
      technician: "R. Sharma",
      notes: "Rotated front tyres, wear pattern normal.",
    },
    {
      date: "10 Jun 2026",
      type: "Hydraulic Fluid Top-up",
      technician: "S. Iyer",
      notes: "Topped up hydraulic fluid, no leaks detected.",
    },
    {
      date: "28 May 2026",
      type: "Engine Inspection",
      technician: "A. Verma",
      notes: "Minor vibration noted, scheduled for recheck.",
    },
    {
      date: "14 May 2026",
      type: "Suspension Check",
      technician: "S. Iyer",
      notes: "Bushings within tolerance, no action needed.",
    },
    {
      date: "30 Apr 2026",
      type: "Tyre Replaced",
      technician: "R. Sharma",
      notes: "Rear left tyre replaced due to sidewall wear. (Ref: TY-9921)",
    },
    {
      date: "18 Apr 2026",
      type: "Health Check Update",
      technician: "You",
      notes: "Routine component condition update.",
    },
    {
      date: "02 Apr 2026",
    ...
    },
    {
      ...
      technician: "A. Verma",
      notes: "Full oil and filter change completed.",
    },
    {
      date: "05 Mar 2026",
      type: "Health Check Update",
      technician: "R. Sharma",
      notes: "All components within normal operating range.",
    },
  ],
};

// Simulates a network call — swap the body for the real service calls above.
async function fetchAssignedMachineFromApi(): Promise<FleetMachine | null> {
  await new Promise((resolve) => setTimeout(resolve, 900));
  return MOCK_ASSIGNED_MACHINE;
}
...
const StyledSelect = ({
  ...
  <div className="relative">
    <select
      ...
      className="w-full appearance-none rounded-lg border border-slate-200 bg-white py-2 pl-3.5 pr-9 text-sm font-medium text-slate-800 focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500/10 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
    >
      {placeholder && (
...
export default function OperatorMachineDashboard() {
  ...
  const fetchAssignedMachine = useCallback(async () => {
    try {
      ...
      const found = await fetchAssignedMachineFromApi();
      setMachine(found);
    } catch (err) {
      console.error("Failed to load assigned machine:", err);
      setLoadError("Couldn't load your machine data. Please try refreshing.");
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F8FAFC] to-[#F1F5FB] p-5 dark:bg-gradient-to-b dark:from-[#0F172A] dark:to-[#020617]">
      ...
      <div className="mx-auto max-w-[1500px] space-y-5">
        {/* ── HEADER ── */}
        <div className="rounded-[28px] bg-gradient-to-r from-indigo-700 via-blue-700 to-indigo-800 px-8 py-8 shadow-lg">
              ...
              <div className="flex flex-col gap-7 lg:flex-row lg:items-center">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="mt-5 inline-flex items-center gap-2 rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white shadow-md transition hover:bg-blue-700 active:shadow-sm"
                  >
