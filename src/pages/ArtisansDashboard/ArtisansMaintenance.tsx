...
export default function ArtisansMaintenance() {
  ...
  const totalPages = Math.max(
    1,
    Math.ceil(filteredMaintenanceList.length / ITEMS_PER_PAGE),
  );

  const paginatedMaintenanceList = useMemo(() => {
    const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;

    return filteredMaintenanceList.slice(
      startIndex,
  ...
  const endItem = Math.min(
    ...
    filteredMaintenanceList.length,
  );
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] p-4 dark:bg-[#061426] sm:p-6 lg:p-8">
      <div className="mx-auto max-w-[1400px] space-y-6">
        {/* Header */}
        <div className="relative overflow-hidden rounded-[17px] border border-slate-200 bg-gradient-to-r from-[#3B37E6] via-[#3730D9] to-[#2E2AD9] px-6 py-6 shadow-[0_20px_60px_-15px_rgba(59,55,230,0.45)] dark:border-slate-700 dark:from-[#1E3A8A] dark:via-[#1D4ED8] dark:to-[#2563EB]">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-blue-100">
              Track pending, in-progress and completed maintenance activities,
              monitor service schedules and manage maintenance operations across
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-[8px] border border-orange-100 bg-orange-50 p-5 text-orange-600 dark:border-orange-500/10 dark:bg-orange-500/10 dark:text-orange-400">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="rounded-[8px] border border-blue-100 bg-blue-50 p-5 text-blue-600 dark:border-blue-500/10 dark:bg-blue-500/10 dark:text-blue-400">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-black uppercase tracking-wider">
                  In Progress
          ...
          <div className="rounded-[8px] border border-green-100 bg-green-50 p-5 text-green-600 dark:border-green-500/10 dark:bg-green-500/10 dark:text-green-400">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-black uppercase tracking-wider">
                  Completed
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <div className="relative">
                ...
                <AppSelect
                  value={statusFilter}
                  onChange={(value) =>
                    handleStatusFilterChange(value as "All" | MaintenanceStatus)
                  }
              ...
              <AppSelect
                ...
                onChange={(value) =>
                  handlePriorityFilterChange(
                    value as "All" | MaintenancePriority,
                  )
                }
              ...
              <button
                ...
                className="h-11 rounded-[8px] border border-gray-200 bg-white px-4 text-sm font-black text-slate-600 transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:bg-white/10"
              >
                Clear
              </button>
            </div>
          ...
          {paginatedMaintenanceList.length > 0 ? (
            <div className="space-y-4">
              {paginatedMaintenanceList.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col gap-4 rounded-[8px] border border-gray-100 bg-[#F8FAFC] p-5 transition hover:border-blue-100 hover:bg-blue-50/30 dark:border-white/5 dark:bg-white/5 dark:hover:border-blue-500/20 md:flex-row md:items-center md:justify-between"
                >
          ...
          {filteredMaintenanceList.length > 0 && (
            <div className="mt-5 flex flex-col gap-3 border-t border-gray-100 pt-4 dark:border-white/10 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-xs font-bold text-slate-500 dark:text-slate-400">
                ...
                {filteredMaintenanceList.length} records
              </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <AppSelect
                  value={formStatus}
                  onChange={(value) =>
                    setFormStatus(value as MaintenanceStatus)
                  }
              ...
              <div>
                ...
                <AppSelect
                  value={formPriority}
                  onChange={(value) =>
                    setFormPriority(value as MaintenancePriority)
                  }
