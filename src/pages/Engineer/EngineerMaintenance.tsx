      ...
      <div className="mx-auto max-w-[1400px] space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Track pending, in-progress and completed maintenance work.
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  value={formStatus}
                  onChange={(event) =>
                    setFormStatus(event.target.value as MaintenanceStatus)
                  }
              ...
              <div>
                ...
                <select
                  value={formPriority}
                  onChange={(event) =>
                    setFormPriority(event.target.value as MaintenancePriority)
                  }
                  className="h-12 w-full rounded-2xl border border-gray-200 bg-white px-4 text-sm font-bold text-slate-700 outline-none transition focus:border-blue-400 dark:border-white/10 dark:bg-white/5 dark:text-white"
                >
                  <option value="High">High</option>
