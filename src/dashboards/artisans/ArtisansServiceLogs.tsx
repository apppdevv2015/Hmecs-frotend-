...
const serviceLogSchema = z
  ...
  .superRefine((data, ctx) => {
    if (data.nextServiceDate && data.serviceDate && data.nextServiceDate < data.serviceDate) {
      ctx.addIssue({
            ...
            <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-blue-100">
                  Manage machine maintenance records, service history, inspection activities, repair
                  tracking and operational service logs from a centralized maintenance platform.
                </p>
              </div>
          ...
          {isView ? (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                  <p className="text-xs font-bold uppercase text-slate-400">Machine Information</p>

                  <h3 className="mt-3 text-lg font-bold text-slate-800 dark:text-white">
                    {formData.machineName}
                  </h3>

                  <p className="mt-1 text-sm text-slate-500">{formData.machineId}</p>

                  <p className="mt-2 text-sm text-slate-500">{formData.site}</p>
                </div>

                <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                  <p className="text-xs font-bold uppercase text-slate-400">Service Information</p>
              ...
              <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                  ...
                  <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-700">
                    ...
                    <p className="mt-2 font-semibold">{formData.nextServiceDate}</p>
                  </div>

                  <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-700">
                    <p className="text-xs text-slate-400">Runtime</p>
                    <p className="mt-2 font-semibold">{formData.runtimeHours} hrs</p>
                  </div>
                </div>
              </div>

              <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                <h3 className="font-semibold text-slate-800 dark:text-white">Issue Found</h3>
              ...
              <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                <h3 className="font-semibold text-slate-800 dark:text-white">Action Taken</h3>
              ...
              <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-700">
                <h3 className="font-semibold text-slate-800 dark:text-white">Remarks</h3>
            ...
            <>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <select
                    ...
                    onChange={(e) => {
                      const machine = assignedMachines.find(
                        (m: Machine) => m.machineId === e.target.value,
                      );
                  ...
                  >
                    ...
                    {assignedMachines.map((machine: Machine) => (
              ...
              <div className="space-y-2">
                ...
                <div className="mt-1 min-h-[20px]">
                  <p className="text-sm text-red-500">{formErrors.serviceDate || ""}</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="mt-1 min-h-[20px]">
                  <p className="text-sm text-red-500">{formErrors.nextServiceDate || ""}</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) => updateField("runtimeHours", Number(e.target.value))}
                  className={inputCls}
                  placeholder="120"
                />

                <div className="mt-1 min-h-[20px]">
                  <p className="text-sm text-red-500">{formErrors.runtimeHours || ""}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => updateField("status", e.target.value as ServiceLogStatus)}
                    className={inputCls}
                  >
                    {statusOptions.map((status) => (
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => updateField("priority", e.target.value as ServiceLogPriority)}
                    className={inputCls}
                  >
                    {priorityOptions.map((priority) => (
              ...
              <div className="space-y-2">
                ...
                <div className="mt-1 min-h-[20px]">
                  {formErrors.issueFound && (
                    <p className="text-sm text-red-500">{formErrors.issueFound}</p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                {formErrors.actionTaken && (
                  <p className="mt-1 text-sm text-red-500">{formErrors.actionTaken}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {formErrors.remarks && (
                  <p className="mt-1 text-sm text-red-500">{formErrors.remarks}</p>
                )}
              </div>
            </>
          )}
