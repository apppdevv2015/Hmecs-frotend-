...
export default function ArtisansAlerts() {
  ...
  const startItem = filteredAlerts.length === 0 ? 0 : (currentPage - 1) * ITEMS_PER_PAGE + 1;
        ...
        <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-r from-[#3B37E6] via-[#3730D9] to-[#2E2AD9] px-6 py-6 shadow-[0_20px_60px_-15px_rgba(59,55,230,0.45)] dark:border-slate-700 dark:from-[#1E3A8A] dark:via-[#1D4ED8] dark:to-[#2563EB]">
          ...
          <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div>
              ...
              <h1 className="text-3xl font-black tracking-tight text-white">Predictive Alerts</h1>

              <p className="mt-3 max-w-2xl text-sm leading-6 text-blue-100">
                Review critical predictive alerts, machine risk warnings, component health
                degradation and maintenance recommendations from your assigned fleet.
              </p>
            </div>
          ...
          {paginatedAlerts.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      >
                        {isAcknowledged ? <CheckCircle2 size={24} /> : <AlertTriangle size={24} />}
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs font-bold text-slate-400">{alert.time}</p>
                      </div>
                    </div>
            ...
            <div className="flex min-h-[280px] flex-col items-center justify-center rounded-3xl border border-dashed border-gray-200 bg-[#F8FAFC] p-8 text-center dark:border-white/10 dark:bg-white/5">
              ...
              <p className="mt-1 max-w-md text-sm font-medium text-slate-500 dark:text-slate-400">
                No alert matches your current search or filter. Try clearing filters.
              </p>
