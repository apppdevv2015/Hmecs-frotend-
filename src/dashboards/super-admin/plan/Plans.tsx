...
const featuresToText = (features: Record<string, boolean> | string[] | null | undefined) => {
    ...
    <div className="relative min-h-screen bg-gray-50 p-4 dark:bg-slate-950 md:p-6">
        ...
        <div className="overflow-hidden rounded-t-2xl border border-blue-700/30 bg-gradient-to-r from-blue-800 via-blue-700 to-blue-800 px-6 py-6 shadow-lg">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div>
              ...
              <h1 className="text-3xl font-black tracking-tight text-white">Plans</h1>

              <p className="mt-2 text-sm font-medium text-blue-100">
                Manage subscription plans, pricing, features, and plan availability across the
                platform.
              </p>
            </div>
            ...
            >
              {plans.map((plan) => (
                ...
                >
                  ...
                  <div className="font-semibold text-green-600">{plan.price}</div>

                  <div className="text-slate-700 dark:text-slate-300">{plan.machines} Machines</div>

                  <div className="text-slate-700 dark:text-slate-300">{plan.staffLimit} Staff</div>

                  <div className="text-slate-700 dark:text-slate-300">{plan.validityDays} Days</div>
      ...
      {deletePlan && (
        ...
        >
          ...
          >
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">Delete Plan</h2>
...
function PlanForm({
  ...
  const errorClass = "mt-1.5 text-xs font-medium text-red-500 dark:text-red-400";
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div>
        ...
        {errors.staffLimit && <p className={errorClass}>{errors.staffLimit.message}</p>}
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="10"
        />
        {errors.machines && <p className={errorClass}>{errors.machines.message}</p>}
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="30"
        />
        {errors.validityDays && <p className={errorClass}>{errors.validityDays.message}</p>}
      </div>
      ...
      {showFeatures && (
        <div className="md:col-span-2">
          ...
          <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
            Add features with comma separation. Example: Engine Monitoring, Hydraulic Monitoring
          </p>
        </div>
      )}
      ...
      {!showFeatures && (
        <div className="md:col-span-2 rounded-xl border border-orange-200 bg-orange-50 px-4 py-3 text-sm text-orange-700 dark:border-orange-500/20 dark:bg-orange-500/10 dark:text-orange-300">
          Update API only accepts plan name, machine limit, price and validity days. Features are
          not sent in update payload.
        </div>
      )}
    </div>
  );
