  ...
  return (
    <div className="min-h-screen bg-[#F4F7FB] p-5 dark:bg-[#020617]">
      <div className="mx-auto max-w-[1700px] space-y-6">
        {/* ── HEADER ──────────────────────────────────────── */}
        <div className="relative overflow-hidden rounded-[20px] border border-slate-200 bg-gradient-to-r from-[#3B37E6] via-[#3730D9] to-[#2E2AD9] shadow-xl dark:border-slate-700 dark:from-[#1E3A8A] dark:via-[#1D4ED8] dark:to-[#2563EB]">
          {/* Decorative Effects */}
          ...
          <div className="relative flex flex-col gap-6 p-7 xl:flex-row xl:items-center xl:justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h1 className="text-3xl font-black tracking-tight text-white">
                    Supervisor Fleet Monitoring
                  </h1>

                  <p className="mt-2 text-sm text-blue-100">
                    Monitor all company machines, health status, operator activity, critical alerts
                    and fleet performance from a centralized dashboard.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                disabled={loading}
                className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/10 px-5 text-sm font-semibold text-white backdrop-blur-md transition-all duration-200 hover:bg-white/20 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <RefreshCcw size={17} strokeWidth={2.4} className={loading ? "animate-spin" : ""} />
