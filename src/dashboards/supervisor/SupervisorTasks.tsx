...
export default function SupervisorTaskPage() {
  ...
  const unassignedOperators = operators.filter((op) => !op.assignedMachine).length;
  ...
  const paginatedOperators = filteredOperators.slice(startIndex, startIndex + PAGE_SIZE);
  ...
  useEffect(() => {
    const shouldHideLayout = isModalOpen;
        ...
        <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-blue-100">
              Assign machines, manage engineers, monitor operator allocations and track workforce
              responsibilities from a centralized task management dashboard.
            </p>
          </div>
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold text-emerald-600">{assignedOperators}</h2>
            </div>
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold text-orange-500">{unassignedOperators}</h2>
            </div>
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold text-violet-600">{engineers.length}</h2>
            </div>
      ...
      <div className="overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-sm [zoom:0.88] origin-top dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="flex flex-col gap-4 border-t border-slate-200 px-6 py-4 dark:border-slate-800 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-slate-500">
            Showing {startItem}-{endItem} of {filteredOperators.length} operators
          </p>
          ...
          <div className="w-full max-w-4xl rounded-[28px] bg-white p-6 shadow-2xl dark:bg-slate-900">
            <div className="mb-6 flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Complete assignment details.</p>
              </div>
            ...
            {(() => {
              const selectedOperator = operators.find((op) => op.id === selectedEngineerView);
              ...
              return (
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-5 dark:border-slate-700 dark:bg-slate-950 md:col-span-2">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500">Operator ID: {selectedOperator.id}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[22px] border border-slate-200 p-5 dark:border-slate-700">
                    <p className="text-xs uppercase tracking-wide text-slate-400">Engineer</p>
          ...
          <div className="relative w-full max-w-[95vw] sm:max-w-xl md:max-w-2xl rounded-[28px] bg-white p-4 sm:p-6 md:p-8 shadow-2xl dark:bg-slate-900">
            ...
            <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="relative w-full">
                  <Select
                    ...
                    value={
                      availableOperators
                        ...
                        .find((item) => item.value === selectedOperatorId) || null
                    }
                    onChange={(selected) => updateField("operatorId", selected?.value || "")}
                    ...
                    styles={{
                      control: (base) => ({
                        ...
                        borderColor: formErrors.operatorId ? "#ef4444" : base.borderColor,

                        boxShadow: formErrors.operatorId
                  ...
                  <div className="mt-1 min-h-[20px]">
                    {formErrors.operatorId && (
                      <p className="text-xs font-medium text-red-500">{formErrors.operatorId}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onChange={(selected) => updateField("machine", selected?.value || "")}
                  ...
                  styles={{
                    control: (base) => ({
                      ...
                      borderColor: formErrors.machine ? "#ef4444" : base.borderColor,

                      boxShadow: formErrors.machine
                        ? "0 0 0 2px rgba(239,68,68,.15)"
                        : base.boxShadow,
                ...
                <div className="mt-1 min-h-[20px]">
                  {formErrors.machine && (
                    <p className="text-xs font-medium text-red-500">{formErrors.machine}</p>
                  )}
                </div>
              </div>
              {/* Engineer */}
              <div className="md:col-span-2">
                ...
                <select
                  ...
                  className={`h-14 w-full rounded-2xl bg-slate-100 px-4 outline-none transition-all dark:bg-slate-950 dark:text-white ${
                    formErrors.engineer
                      ? "border border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20"
                      : "border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-slate-700"
                  }`}
                >
                ...
                <div className="mt-1 min-h-[20px]">
                  {formErrors.engineer && (
                    <p className="text-xs font-medium text-red-500">{formErrors.engineer}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                disabled={!selectedOperatorId || !selectedMachine || !selectedEngineer}
