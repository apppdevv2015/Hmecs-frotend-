        ...
        setLogs([
          {
            ...
            machineName: formattedMachines[0]?.machineName || "Caterpillar 6040 Excavator",
...

          {
            ...
            machineName: formattedMachines[1]?.machineName || "Komatsu HD785 Dump Truck",
...

          {
            ...
            machineName: formattedMachines[2]?.machineName || "Hitachi EX3600 Excavator",
...

          {
            ...
            machineName: formattedMachines[3]?.machineName || "Caterpillar D11T Dozer",
...

          {
            ...
            machineName: formattedMachines[4]?.machineName || "Volvo A40G Articulated Hauler",
            ...
            <div className="relative flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-sm leading-6 text-blue-100">
                  Monitor machine service activities, review maintenance records, track engineer
                  assignments, and ensure timely completion of service operations across your fleet.
                </p>
              </div>
            </div>
          </div>
