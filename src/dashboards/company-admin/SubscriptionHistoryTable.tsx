          ...
          <tbody className="divide-y divide-blue-50 dark:divide-slate-700/50">
            {history && history.length > 0 ? (
              history.map((item) => {
                ...
                const price = item.price ?? item.plan?.price ?? (item as any).amount ?? "0.00";
                ...
                const displayStatus =
                  item.payment_status || item.paymentStatus || item.status || "Pending";
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          >
                            {["active", "paid"].includes(displayStatus.toLowerCase()) && (
